...
const { regenerateJoinCode, createTeam, getMyTeams, deleteTeam, updateTeam, getTeamById, getTeamAthletes, kickAthleteFromTeam, joinTeamByCode, leaveTeam} = require("../controllers/teamsController");
